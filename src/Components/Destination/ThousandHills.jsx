  ...
  return (
    <div className=' bg-white'>
        ...
        <div className='relative'>
          <img alt='spirit of Uganda Safari' src='http://intriqjourney-dev.harnods-server.com/wp-content/uploads/2020/06/Country-Rwanda-1820x697_c.jpg' className='w-full'/>
