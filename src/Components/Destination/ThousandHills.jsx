  ...
  return (
    <div className=' bg-white'>
        ...
        <div className='relative'>
          <img alt='spirit of Uganda Safari' loading='lazy' src='http://intriqjourney-dev.harnods-server.com/wp-content/uploads/2020/06/Country-Rwanda-1820x697_c.jpg' className='w-full'/>
          <h1 className=" md:absolute md:bottom-0 text-white text-3xl lg:text-7xl font-[SourceSerifPro-Regular] md:l-10 z-0"> <strong>Treasures  Of a Thousand  Hills</strong> </h1>
        </div>
        ...
        <div className=' lg:px-[200px] px-[70px]'>
          ...
          <div>
              ...
              <div className='lg:flex items-center justify-center'>
                ...
                <img alt='Arival' loading='lazy' src='https://image-tc.galaxy.tf/wijpeg-2w7ueb8np3077348kg8u539fy/hr-dsc-5646.jpg?width=1600&height=1066' className=' lg:w-1/2 ml-5'/>
              ...
              <div>
                ...
                <div className='lg:flex items-center justify-center'>
                  ...
                  <img alt='Arival' loading='lazy' src='https://upload.wikimedia.org/wikipedia/commons/a/ae/Genocide_Memorial_site_of_Gisozi_Kigali_Genocide_Memorial_021.jpg' className=' lg:w-1/2 ml-5'/>
                ...
                <div className='lg:flex items-center justify-center'>
                  ...
                  <img alt='Arival' loading='lazy' src='https://live.staticflickr.com/114/290786253_f798d07a53_b.jpg' className=' lg:w-1/2 ml-5'/>
                ...
                <div className='lg:flex items-center justify-center'>
                  ...
                  <img alt='Arival' loading='lazy' src='https://upload.wikimedia.org/wikipedia/commons/0/00/Gorillas_of_Volcanoes_National_park.jpg' className=' lg:w-1/2 ml-5'/>
...
<br/><br/>Dedicate the rest of the day to discovering a wide range of activities both on the property and in its vicinity. You have the opportunity to embark on adventures right at the resort, such as enjoying the pristine blue swimming pool, indulging in spa treatments, kayaking, and taking exhilarating rides on speedboats.                   </p>
                  <img alt='Arival' loading='lazy' src='https://www.safarisrwandasafari.com/wp-content/uploads/2023/03/lake-kivu-rwanda.jpg' className=' lg:w-1/2 ml-5'/>
                ...
                <div className='lg:flex items-center justify-center'>
                  ...
                  <img alt='Arival' loading='lazy' src='https://journeysbydesign.com/wp-content/uploads/2017/01/%C2%A9-Stella-Wadulo.jpg' className=' lg:w-1/2 ml-5'/>
                ...
                <div className='lg:flex items-center justify-center'>
                  ...
                  <img alt='Arival' loading='lazy' src='https://live.staticflickr.com/4080/4945696386_5d9dda6334_b.jpg' className=' lg:w-1/2 ml-5'/>
...
Nyungwe Forest is an exceptional location for observing chimpanzees in their natural habitat. The park's primary attractions include its diverse monkey species, with chimpanzees being the highlight. Additionally, you'll have the chance to encounter various primates such as the abundant l'Hoest's monkeys, Grey-cheeked mangabeys, and the largest known group of Rwenzori colobus monkeys.                   </p>
                  <img alt='Arival' loading='lazy' src='https://uniglobeletsgotravel.com/wp-content/uploads/2019/02/gorilla-group-1.jpg' className=' lg:w-1/2 ml-5'/>
                ...
                <div className='lg:flex items-center justify-center'>
                  ...
                  <img alt='Arival' loading='lazy' src='https://www.explorerwandatours.com/wp-content/uploads/2019/08/Kigali-City-750x450.jpg' className=' lg:w-1/2 ml-5'/>
