  ...
  return (
    ...
    <div className='relative '>
        ...
        <div className=' lg:px-[200px] px-[70px]'>
          ...
          {clicked && isActive===1?  <img alt='Arival' loading='lazy' src='https://cdn.audleytravel.com/798/570/79/261974-kigali-serena-hotel-kigali.jpg' className=' lg:w-1/2 w-full object-contain'/>:<div/>}
          ...
          {clicked && isActive===2?  <img alt='Arival' loading='lazy' src='https://upload.wikimedia.org/wikipedia/commons/0/0d/Genocide_Memorial_site_of_Gisozi_Kigali_Genocide_Memorial_007.jpg' className=' lg:w-1/2 w-full object-contain'/>:<div/>}
          ...
          {clicked && isActive===3?  <img alt='Arival' loading='lazy' src='https://upload.wikimedia.org/wikipedia/commons/6/65/Webp.net-compress-image-59.jpg' className=' lg:w-1/2 w-full object-contain'/>:<div/>}
          ...
          {clicked && isActive===4?  <img alt='Arival' loading='lazy' src='https://live.staticflickr.com/5705/22819687517_9305a08039_b.jpg' className=' lg:w-1/2 w-full object-contain'/>:<div/>}
          ...
          {clicked && isActive===5?  <img alt='Arival' loading='lazy' src='https://upload.wikimedia.org/wikipedia/commons/a/a9/Topi_in_Akagera_National_Park_1.jpg' className=' lg:w-1/2 w-full object-contain'/>:<div/>}
          ...
          {clicked && isActive===6?  <img alt='Arival' loading='lazy' src='https://upload.wikimedia.org/wikipedia/commons/a/a1/1-Virunga_Lodge_Aerila_ViewSinamatella_-_Rwanda_-_Virunga_-_20180915_-_1054.jpg' className=' lg:w-1/2 w-full object-contain'/>:<div/>}
          ...
          {clicked && isActive===7?  <img alt='Arival' loading='lazy' src='https://www.amboseliparkkenya.com/wp-content/uploads/2020/10/asasff-750x450.jpg' className=' lg:w-1/2 w-full object-contain'/>:<div/>}
          ...
          {clicked && isActive===8?  <img alt='Arival' loading='lazy' src='https://ujuzitravel.com/wp-content/uploads/2022/01/rwanda-volcanoes-golden-monkey-shutterstock.jpg' className=' lg:w-1/2 w-full object-contain'/>:<div/>}
          ...
          {clicked && isActive===9?  <img alt='Arival' loading='lazy' src='https://image-tc.galaxy.tf/wijpeg-b9x7g9tddzlq2za9p0d8wto8c/hr-dsc-5630.jpg' className=' lg:w-1/2 w-full object-contain'/>:<div/>}
        ...
        <div className=' flex justify-between'>
          ...
          <div>
              ...
              <div className='lg:flex items-center justify-center'>
                ...
                <a href='/rwanda/lodges/kigaliserena' className='flex items-center underline decoration-orange-500'>
...
<br/><br/>After a satisfying lunch at a nearby eatery, you'll have the opportunity to explore the coffee-making process in Kigali, from cultivating and harvesting the beans to roasting and brewing.
                ...
                <h1 className='font-semibold text-xl mb-2'>Accomodation</h1>
                <a href="/rwanda/lodges/magashi" className='flex items-center underline decoration-orange-500'>
                ...
                <h1 className='font-semibold text-xl mb-2'>Accomodation</h1>
                <a href='/rwanda/lodges/bisate' className='flex items-center underline decoration-orange-500'>
