      ...
      <div className=" flex flex-col items-center m-auto p-5" id= 'Destination'>
        ...
        <div className="">
            ...
            <div className=" w-full mb-20 relative bg-white lg:w-[90%] m-auto p-5 flex flex-col justify-center items-center rounded-md shadow-md">
                ...
                <h2 className=' text-xl italic font-bold mb-10'> Discover the wonders of Kenya with a touch of luxury </h2>
                <p className=' font-[SourceSerifPro-Regular] lg:px-[100px]'>
            ...
            <div className=" w-full mb-20 relative bg-white lg:w-[90%] m-auto p-5 flex flex-col justify-center items-center rounded-md shadow-md">
                ...
                <h2 className=' text-xl italic font-bold mb-10'> An adventure  that feeds your Soul.</h2>
                <p className=' font-[SourceSerifPro-Regular] lg:px-[100px]'>
            ...
            <div className=" w-full mb-20 relative bg-white lg:w-[90%] m-auto p-5 flex flex-col justify-center items-center rounded-md shadow-md">
                ...
                <h2 className=' text-xl italic font-bold mb-10'>MARA -TSAVO –WATAMU. Explore the Kenyan  wildlife  havens  in Style.</h2>
                <p className=' font-[SourceSerifPro-Regular] lg:px-[100px]'>
            ...
            <div className=" w-full mb-20 relative bg-white lg:w-[90%] m-auto p-5 flex flex-col justify-center items-center rounded-md shadow-md">
                ...
                <h2 className=' text-xl italic font-bold mb-10'>A truly compelling and quintessential  Kenyan Safari experience. </h2>
                <p className=' font-[SourceSerifPro-Regular] lg:px-[100px]'> 
