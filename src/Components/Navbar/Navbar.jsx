            ...
            <div className=' flex justify-between items-center relative' >
                ...
                <div className=' hidden lg:inline absolute lg:left-[400px] md:left-[200px] border-white border-x-[1px] px-5'>
                    ...
                    <div className=' flex justify-center items-center'>
                            ...
                            <a href="https://wa.me/+254716251932" className=' cursor-pointer'><h1 className=' font-bold text-white'> +254716251932 </h1></a>
                    </div>
            ...
            </div>
            {
                isOpen ? 
                    <ul className="lg:flex lg:items-center z-[-1] lg:z-auto lg:static absolute bg-white w-full left-0 lg:w-auto lg:opacity-100 opacity-100 transition-all ease-in duration-500">
                        ...
                        <li className=" mx-4 my-6 ">
                            <a href="/safaris" className=" hover:text-[#f15d30] duration-500 font-[SourceSerifPro-Black]">Luxury Safaris</a> 
                        </li>
                        <li className=" mx-4 my-6 ">
                            <a href="/faqs" className=" hover:text-[#f15d30] duration-500 font-[SourceSerifPro-Black]">FAQs</a> 
                        </li>
                        <li className=" mx-4 my-6 ">
                            <a href="/contacts" className=" hover:text-[#f15d30] duration-500 font-[SourceSerifPro-Black]">Contacts/Inquiry</a> 
                        </li>
                        <li className=" mx-4 my-6 ">
                            <a href="https://wa.me/+254716251932" className=" hover:text-[#f15d30] duration-500 font-[SourceSerifPro-Black]">Plan for a trip call +254716251932 </a> 
                        </li>
                    </ul> 
                :
                    <ul className=" lg:flex lg:items-center z-[-1] lg:z-auto lg:static absolute w-full left-0 lg:w-auto lg:opacity-100 opacity-0 top-[-400px] transition-all ease-in duration-500">
                        ...
                        <li className=" mx-4 my-6 ">
                            <a href="/safaris" className=" hover:text-yellow-400 duration-500 text-white font-[SourceSerifPro-Black]">Luxury Safaris</a> 
                        </li>
                        <li className=" mx-4 my-6 ">
                            <a href="/faqs" className=" hover:text-yellow-400 duration-500 text-white font-[SourceSerifPro-Black]">FAQS</a> 
                        </li>
                        <li className=" mx-4 my-6 ">
                            <a href="/contacts" className=" hover:text-yellow-400 duration-500 text-white font-[SourceSerifPro-Black]">Contacts/Inquiry</a> 
                        </li>
                    </ul>
            }
