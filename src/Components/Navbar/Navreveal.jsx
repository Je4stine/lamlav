...
const Navreveal =()=>{
    ...
    return (
        <nav className=" w-full top-0 z-[1] min-[768px]:flex min-[768px]:justify-between max-[768px]:bg-white px-5 bg-white sticky shadow-md">
            <div className=' max-[768px]:flex max-[768px]:justify-between items-center' >
                <h1 className=" mx-4 my-6 font-bold text-2xl ">Lamlav</h1>
            ...
            </div>
            {
                ...
                :
                    <ul className=" min-[768px]:flex min-[768px]:items-center z-[-1] min-[768px]:z-auto min-[768px]:static absolute max-[768px]:bg-white w-full left-0 min-[768px]:w-auto min-[768px]:opacity-100 opacity-0 top-[-400px] transition-all ease-in duration-500">
                        <li className=" mx-4 my-6 "> 
                        <a href="#1" className=" hover:text-[#f15d30] duration-500 font-bold">Home</a>  
                        </li>
                        <li className=" mx-4 my-6 ">
                            <a href="#1" className=" hover:text-[#f15d30] duration-500 font-bold">Safaris</a> 
                        </li>
                        <li className=" mx-4 my-6 ">
                            <a href="#1" className=" hover:text-[#f15d30] duration-500 font-bold">About</a> 
                        </li>
                        <li className=" mx-4 my-6 ">
                            <a href="#1" className=" hover:text-[#f15d30] duration-500 font-bold">Contacts</a> 
                        </li>
                    </ul>
            }
