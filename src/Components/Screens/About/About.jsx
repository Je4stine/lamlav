        ...
        <div>
           ...
           <div className=' parallax2'>
                <div className=" absolute top-[40%] left-[45%] max-[768px]:left-[32%]">
                    <h1 className=" text-white text-6xl font-bold max-[768px]:text-4xl ">ABOUT US</h1>
                </div>
           ...
           <div className=" min-[768px]:px-[550px] max-[768px]:p-10 py-10 bg-white flex flex-col" id="about">
                ...
                <p className="mb-6 font-[SourceSerifPro-Regular] text-lg max-[768px]:text-md ">
