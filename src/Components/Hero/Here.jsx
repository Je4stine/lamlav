    ...
    return (
       <div className='parallax'>
            <div className=' w-full h-full'>
                ...
                <h1 className=' text-white absolute font-[SourceSerifPro-Black] top-[32vh] text-7xl left-16 mt-5 max-[768px]:text-5xl max-[768]:left-10 max-[768px]:mt-0 max-[768px]:font-bold' >Lets us take you <br /> places</h1>
