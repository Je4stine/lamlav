        ...
        <div className=" bg-white">
            ...
            <section className=" bg-white w-[100%] m-auto lg:px-[500px] px-10" >
                ...
                <div className=" mb-20 m-auto">
                    <h1 className=" font-[SourceSerifPro-Bold] pt-[50px] text-xl lg:text-4xl m-auto mb-20">Camps and Lodge in Meru</h1>
                     <Swiper
                        ...
                        <SwiperSlide>
                            <div className=" relative z-[7]">
                                ...
                                <h1 className=" absolute top-[20%] left-[40%] text-white font-bold text-2xl">ELSA'S  KOPJE  </h1>
