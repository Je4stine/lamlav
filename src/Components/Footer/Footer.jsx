    ...
    return (
        <div className=" bg-black w-full p-5  ">
            <div className=' flex flex-1 justify-between max-[768px]:flex-col'> 
                <div className=' flex flex-col flex-1 items-center'>
                    <div className=' flex item-center'>
                        <h2 className=' text-white max-[768px]:hidden'>Lamlav</h2>
                    </div>
                ...
                <div className=' flex flex-col flex-1'>
                    <div className=' flex flex-col items-center'>
                        ...
                        <a href='#1' className=' no-underline text-gray-400 max-[768px]:text-sm'> Home</a>
                        <a href="#1" className=' no-underline text-gray-400 max-[768px]:text-sm'>About US</a>
                        <a href='#1' className=' no-underline text-gray-400 max-[768px]:text-sm'>Policies</a>
                        <a href='#1' className=' no-underline text-gray-400 max-[768px]:text-sm'>FAQs</a>
                    </div>
                </div>
                ...
                <div className=' flex flex-col flex-1 items-center'>
                    ...
                    <div className='flex max-[768px]:items-center '>
                         ...
                         <p className=' text-gray-400 m-2 max-[768px]:text-sm'>Lamlav Leisure Safaris </p>
                    </div>
          ...
          <div className=' m-auto flex items-center'>
                <p className=' text-gray-400 m-auto text-center mt-5 max-[768px]:text-sm'>All rights reserved  &#169; {Today.getFullYear()}- Lamlav Leisure Safaris  </p>
         </div> 
